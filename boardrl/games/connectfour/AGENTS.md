...
- Per-strategy metrics include win rate, points, average actions, policy sensitivity, winning-game count, and the average probability assigned to the final winning move.
